...
urlpatterns = [
    ...
    #face verification
    # path("face-verification/", views.verify_face, name="face-verification"),
    path("verify-face-transaction/", transaction.verify_face_and_process_transaction, name="verify-face-transaction"),
