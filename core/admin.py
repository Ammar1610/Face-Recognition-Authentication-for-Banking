...
class TransactionAdmin(admin.ModelAdmin):
    ...
    list_editable = ['amount','amount_exchange', 'status', 'transaction_type', 'verification_method']
    list_display = ['user', 'amount', 'amount_exchange','status', 'transaction_type', 'reciever', 'sender', 'currency','verification_method', 'face_verification_status']
