...
FACE_VERIFICATION_THRESHOLD = 0.45  # Adjust for stricter/looser matching
FACE_VERIFICATION_TIMEOUT = 300  # 5 minutes in seconds

# Media settings (ensure these exist)
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')

# Session settings for face verification
